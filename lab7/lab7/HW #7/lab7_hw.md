...
![](lab7_hw_files/figure-html/unnamed-chunk-8-1.png)<!-- -->
...
```
The result makes sense, since mammals don't lay eggs. NA can also be used speculate why the data is written as NA. For this case, mammal can only have values of NA in variable egg mass, as mammals don't lay eggs. 
**9. The `amphibio` data have variables that classify species as fossorial (burrowing), terrestrial, aquatic, or  . Calculate the number of NA's in each of these variables. Do you think that the authors intend us to think that there are NA's in these columns or could they represent something else? Explain.**
...
## 4 Ter        1104     16.3
```
I think if we look at the percentages, it can also tell us how many species within a category that don't lay eggs. 
